...
Additional documentation can be found [here](https://doc.zeroc.com/ice/4.0/language-mappings/javascript-mapping/client-side-slice-to-javascript-mapping/slice2js-command-line-options).
